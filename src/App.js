...
export default function LandingPage() {
  const priceRef = useRef(null); //fiyatlandirma bolumune odaklanmak icin useRef hook'u tanimlayalim

  const handleScrollToPrice = () => {
    priceRef.current.scrollIntoView({ behavior: "smooth" });
    //scrollIntoView fonksiyonu, bir HTML elementini görüş alanına getirmek için kullanılır.
    // Bu fonksiyon, bir Element nesnesine aittir ve bu nesne üzerinden çağrılır.
    //behavior parametresi, kaydırma davranışını kontrol eder. Bu parametre, iki farklı değer alabilir: "auto" veya "smooth".
  };
  ...
  return (
    <>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <div className="mt-10 flex items-center justify-center">
                <button
                  onClick={handleScrollToPrice} //butona tıklandığında fiyatlandırma bölümüne smooth bir şekilde kaydırma yapmasi icin
      ...
      <div ref={priceRef} className="py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
